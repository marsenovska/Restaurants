...
namespace Restaurants.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Address,Phone")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Address,Phone")] Restaurant restaurant)
        {
            if (ModelState.IsValid)
            {
